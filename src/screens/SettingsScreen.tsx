...
export function SettingsScreen(): React.JSX.Element {
  ...
  return (
    <section className="screen screen--you">
      ...
      <div className="settings-card settings-card--about"><div className="about-row"><SettingsIcon size={23} /><span><strong>Public-data mode</strong><small>Real API source, no mock data</small></span></div><p><CheckIcon size={14} /> The public proxy requests a temporary read-only source token server-side. No external user credentials are saved by X-sutra.</p></div>
    </section>
  )
}
