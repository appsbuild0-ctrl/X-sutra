      ...
      <div className="dl-gate__card">
        {view === 'pick' && (
          <>
            ...
            <h2>Download</h2>
            {isPremium && (
              // Premium users get multiple download source options
              <>
...
/** Select a download source and start download */
function selectSource(source: string): void {
  // Handle source selection - would trigger appropriate download
  // For now, just close the gate and notify
  console.log(`Selected download source: ${source}`)
}
EOF