...
export function NicheScreen(): React.JSX.Element {
  ...
  return (
    <section className="screen">
      <ScreenHeader title={id} eyebrow="Public niche" actions={<><button className="round-button" type="button" onClick={() => void feed.reload()} aria-label="Refresh niche"><RefreshIcon size={19} /></button><button className="round-button" type="button" onClick={() => navigate(-1)} aria-label="Go back"><ArrowLeftIcon size={19} /></button></>} />
